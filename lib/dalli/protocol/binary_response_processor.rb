...
module Dalli
  module Protocol
    ##
    # Class that encapsulates logic for processing responses from memcached.
    # Includes logic for pulling data from an IO source and parsing into
    # local values.  Handles errors on unexpected values.
    #
    # This class will be renamed when the protocol classes are reorganized
    ##

...
describe Dalli::Protocol::Binary do
  describe "hostname parsing" do
    ...
    it "throws an exception if the hostname cannot be parsed" do
      lambda { Dalli::Protocol::Binary.new("[]") }.must_raise Dalli::DalliError
      lambda { Dalli::Protocol::Binary.new("my.fqdn.com:") }.must_raise Dalli::DalliError
      lambda { Dalli::Protocol::Binary.new("my.fqdn.com:11212,:2") }.must_raise Dalli::DalliError
      lambda { Dalli::Protocol::Binary.new("my.fqdn.com:11212:abc") }.must_raise Dalli::DalliError
    end
  end
  ...
  describe "guard_max_value" do
    ...
    it "throws when size is over max and error_over_max_size true" do
      s = Dalli::Protocol::Binary.new("127.0.0.1", error_when_over_max_size: true)
      value = OpenStruct.new(bytesize: 1_048_577)
